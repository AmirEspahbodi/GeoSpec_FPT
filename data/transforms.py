        ...
        operations = {
            ...
            "rotation": random_apply(
                transforms.RandomRotation(
                    degrees=aug_args.rotation.degrees, fill=aug_args.value_fill
                ),
            ...
            "grayscale": transforms.RandomGrayscale(p=aug_args.grayscale.prob),
            "resize": transforms.Resize(size=(input_size, input_size)),
        }
